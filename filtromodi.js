function main() {
  ...
  deslizadorrojo.oninput = () => {
    ...
    var imgDataRojo = ctx.getImageData(0, 0, canvas.width, canvas.height/2);
  ...
  deslizadorverde.oninput = () => {
    ...
    ctx.drawImage(img, 0,0);
    var imgDataVerde = ctx.getImageData(0, 0, canvas.width, canvas.height/2);
  ...
  deslizadorazul.oninput = () => {
    ...
    ctx.drawImage(img, 0,0);
    var imgDataAzul = ctx.getImageData(0, 0, canvas.width, canvas.height/2);
  ...
  gris.onclick=()=>{
      var imgDataGris = ctx.getImageData(0, canvas.height/2, canvas.width, canvas.height);
      //-- Obtener el array con todos los píxeles
  ...
  ctx.putImageData(imgDataGris, 0, canvas.height/2);
  }
}
